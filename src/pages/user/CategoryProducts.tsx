        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6">
          {products.map(product => (
            <Link 
              ...
              className="group bg-white rounded-2xl p-2 md:p-3 shadow-sm hover:shadow-md transition-all border border-gray-50 flex flex-col h-full"
            >
              <div className="relative aspect-[4/5] mb-3 overflow-hidden rounded-xl bg-gray-50 flex-shrink-0">
                <img 
              ...
              <div className="flex flex-col flex-grow text-center px-1 pb-2">
                ...
                <div className="mt-auto">
                  <span className={`${isVipMode ? 'text-purple-600' : 'text-blue-600'} font-bold text-sm md:text-base`}>
                    {isVipMode ? 'Bulk ' : 'From '}₹{product.discountPrice || product.price}
                  </span>
                </div>
              </div>
            </Link>
